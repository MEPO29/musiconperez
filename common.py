...
DATA_DIR = "/Users/mepo/PycharmProjects/musiconperez/ismir-data-updated"
...
def save_trained_model(trained_models_file, trained_model):
    ...
    df_merge = pd.concat([df, pd.DataFrame([trained_model])], axis=0)
    df_merge.to_csv(trained_models_file, sep='\t', index=False)
